...
<head>
<title>Burgershot - Profile of Gaudeamus271</title>
<!-- start: headerinclude -->
...
<a href="index-2.html">Burgershot</a>
<!-- end: nav_bit --><!-- start: nav_sep_active -->
<i class="fa fa-angle-double-right"></i>
<!-- end: nav_sep_active --><!-- start: nav_bit_active -->
<span class="active">Profile of Gaudeamus271</span>
...
<fieldset>
	<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tr>
			<td width="75%">
				<span class="largetext"><strong><span style="color: #3c71af;">Gaudeamus271</span></strong></span><br />
				<span class="smalltext">
					(Burgershot Member)<br />
					
					<br />
					<strong>Registration Date:</strong> 2019-04-13<br />
					<strong>Date of Birth:</strong> Not Specified <br />
					<strong>Local Time:</strong> 2022-07-30 at 01:15 PM<br />
...
<div>
<a href="privatea3ab.html?action=send&amp;uid=168" class="button"><i class="fa fa-envelope"></i> Send PM</a>
<a href="javascript:MyBB.reputation(168);" class="button"><i class="fa fa-star"></i> Add Reputation</a>
</div><br>
<div id="mobile_profile" style="display:none">
<table border="0" cellspacing="0" cellpadding="7" class="tborder">
				<tr>
					<td colspan="2" class="thead"><strong>Gaudeamus271's Forum Info</strong></td>
				</tr>
				<tr>
					<td class="trow1" style="width: 30%;"><strong>Joined:</strong></td>
					<td class="trow1">2019-04-13</td>
				</tr>
				<tr>
					<td class="trow2"><strong>Last Visit:</strong></td>
					<td class="trow2">2020-05-29, 08:04 PM</td>
				</tr>
				<tr>
					<td class="trow1"><strong>Total Posts:</strong></td>
					<td class="trow1">12 (0.01 posts per day | 0.11 percent of total posts)<br /><span class="smalltext">(<a href="search14b2.html?action=finduser&amp;uid=168">Find All Posts</a>)</span></td>
				</tr>
				<tr>
					<td class="trow2"><strong>Total Threads:</strong></td>
					<td class="trow2">0 (0 threads per day | 0 percent of total threads)<br /><span class="smalltext">(<a href="search858b-2.html?action=finduserthreads&amp;uid=168">Find All Threads</a>)</span></td>
				</tr>
				<tr>
					<td class="trow1"><strong>Time Spent Online:</strong></td>
					<td class="trow1">10 Hours, 38 Minutes, 1 Second</td>
				</tr>
...
<!-- end: postbit_reputation_formatted --> [<a href="reputation4183.html?uid=168">Details</a>] </td>
</tr>
...
<tr>
<td colspan="2" class="thead"><strong>Additional Info About Gaudeamus271</strong></td>
</tr>
<!-- start: member_profile_customfields_field -->
<tr>
<td class="trow1"><strong>Discord ID:</strong></td>
<td class="trow1 scaleimages">219420290755723264</td>
</tr>
...
<div class="theme">
<form method="POST" action="https://www.burgershot.gg/member.php" id="theme_select">
